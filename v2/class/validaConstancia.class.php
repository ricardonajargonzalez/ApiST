...
class validaConstancia {
  ...
  private $constancia;
      ...
      public function __construct($dataarray){
        ...
        $this->nombrearchivo = $dataarray['nombrearchivo'];
        $this->huelladigital = $dataarray['huelladigital'];
        $this->path_asn1 = $dataarray['path_asn1'];
        $this->constancia = $this->get_constancia();
    }

    public function get_constancia(){
       $file = file_get_contents($this->path_asn1);
       $result= $database64 = base64_encode($file);  
    ...
    public function validaConstancia_con_file_asn1(){
          ...
          <soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
            ...
            <soap:Body>
              <validaNOM151 xmlns="http://tempuri.org/">
                <nombreArchivoOriginal>'.$this->nombrearchivo.'</nombreArchivoOriginal>
                <huellaDigitalArchivo>'.$this->huelladigital.'</huellaDigitalArchivo>
                <constancia>'.$this->constancia.'</constancia>
              </validaNOM151>
            </soap:Body>
          </soap:Envelope>';
                  ...
                  if ($err) {
                    return $err;
                     ...
                     if($result_archivo['error'] == false){
                        // var_dump("sin error en generar constancia");
